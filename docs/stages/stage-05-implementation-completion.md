...
Stage 05 FAKE is closed on `main`. Stage 06 specification is the current gate (`docs/stages/stage-06-decision-engine.md`). Do not start Stage 06 runtime or optional Meta paused proof until that specification is approved and merged.
