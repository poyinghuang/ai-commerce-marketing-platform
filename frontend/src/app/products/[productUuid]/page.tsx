...
export default async function ProductDetailPage({ params, searchParams }: { params: Promise<{ productUuid: string }>; searchParams: Promise<{tab?:string}> }) {
  ...
  const tab = requestedTab === "knowledge" || requestedTab === "creative-plans" || requestedTab === "campaigns" || requestedTab === "assets" || requestedTab === "quality" || requestedTab === "creative-factory" ? requestedTab : "product";
