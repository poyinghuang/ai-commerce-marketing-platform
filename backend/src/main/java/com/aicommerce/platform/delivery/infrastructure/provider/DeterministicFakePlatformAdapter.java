...
@Component @Primary @Profile("(local | test) & !production") @ConditionalOnProperty(name="platform.adapter",havingValue="fake")
public class DeterministicFakePlatformAdapter implements PlatformCampaignPort,PlatformAdSetPort,PlatformAdPort,PlatformOperationReconciliationPort {
 ...
 @Override public ProviderKey providerKey(){return ProviderKey.FAKE;}
