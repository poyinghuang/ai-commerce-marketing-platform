...
@Entity @Table(name="platform_accounts") public class PlatformAccount extends MutableEntity {
 ...
 @Enumerated(EnumType.STRING) @Column(name="provider_key",updatable=false) private PlatformProvider providerKey;
 ...
 protected PlatformAccount(){} public UUID getPlatformAccountUuid(){return platformAccountUuid;} public PlatformProvider getProviderKey(){return providerKey;} public String getCurrency(){return currency;} public String getTimezone(){return timezone;}
}
